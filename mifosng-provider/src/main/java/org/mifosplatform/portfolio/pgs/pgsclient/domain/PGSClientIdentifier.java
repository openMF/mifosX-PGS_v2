...
@Entity
@Table(name = "m_pgsclient_identifier", uniqueConstraints = {
...
public class PGSClientIdentifier extends AbstractAuditableCustom<AppUser, Long> {

    @ManyToOne
    @JoinColumn(name = "client_id", nullable = false)
    private PGSClient client;
    ...
    public static PGSClientIdentifier fromJson(final PGSClient client, final CodeValue documentType, final JsonCommand command) {
        final String documentKey = command.stringValueOfParameterNamed("documentKey");
        final String description = command.stringValueOfParameterNamed("description");
        return new PGSClientIdentifier(client, documentType, documentKey, description);
    }

    protected PGSClientIdentifier() {
        //
    }

    private PGSClientIdentifier(final PGSClient client, final CodeValue documentType, final String documentKey, final String description) {
        this.client = client;
