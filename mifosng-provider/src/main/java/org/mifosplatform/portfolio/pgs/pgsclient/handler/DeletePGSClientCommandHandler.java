...
@Service
public class DeletePGSClientCommandHandler implements NewCommandSourceHandler {

    private final PGSClientWritePlatformService clientWritePlatformService;

    @Autowired
    public DeletePGSClientCommandHandler(final PGSClientWritePlatformService clientWritePlatformService) {
