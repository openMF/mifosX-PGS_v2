 ...
 */
package org.mifosplatform.portfolio.pgs.pgsclient.command;
 ...
 */
public class PGSClientIdentifierCommand {

    private final Long documentTypeId;
    private final String documentKey;
    private final String description;

    public PGSClientIdentifierCommand(final Long documentTypeId, final String documentKey, final String description) {
