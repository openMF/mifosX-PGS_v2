...
@Service
public class UpdatePGSClientCommandHandler implements NewCommandSourceHandler {

    private final PGSClientWritePlatformService clientWritePlatformService;

    @Autowired
    public UpdatePGSClientCommandHandler(final PGSClientWritePlatformService clientWritePlatformService) {
