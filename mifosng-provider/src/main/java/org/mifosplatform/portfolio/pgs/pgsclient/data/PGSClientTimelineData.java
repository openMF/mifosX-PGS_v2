...
public class PGSClientTimelineData {
    ...
    public PGSClientTimelineData(final LocalDate submittedOnDate, final String submittedByUsername, final String submittedByFirstname,
