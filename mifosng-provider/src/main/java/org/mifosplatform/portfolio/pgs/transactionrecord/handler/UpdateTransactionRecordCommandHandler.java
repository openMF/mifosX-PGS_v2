...
@Service
public class UpdateTransactionRecordCommandHandler implements NewCommandSourceHandler {

    private final TransactionRecordWritePlatformService writePlatformService;

    @Autowired
    public UpdateTransactionRecordCommandHandler(final TransactionRecordWritePlatformService writePlatformService) {
