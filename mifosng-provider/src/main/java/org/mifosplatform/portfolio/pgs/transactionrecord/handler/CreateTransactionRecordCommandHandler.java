...
@Service
public class CreateTransactionRecordCommandHandler implements NewCommandSourceHandler {

    private final TransactionRecordWritePlatformService writePlatformService;

    @Autowired
    public CreateTransactionRecordCommandHandler(final TransactionRecordWritePlatformService writePlatformService) {
