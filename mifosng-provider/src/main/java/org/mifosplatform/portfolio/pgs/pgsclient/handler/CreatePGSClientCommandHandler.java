...
@Service
public class CreatePGSClientCommandHandler implements NewCommandSourceHandler {

    private final PGSClientWritePlatformService clientWritePlatformService;

    @Autowired
    public CreatePGSClientCommandHandler(final PGSClientWritePlatformService clientWritePlatformService) {
