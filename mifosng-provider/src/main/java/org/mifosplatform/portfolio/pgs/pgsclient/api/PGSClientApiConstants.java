...
public class PGSClientApiConstants {
    ...
    public static final String mifosClientIdParamName = "mifosClientIdParamName"; 
    ...
    public static final Set<String> CLIENT_RESPONSE_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(idParamName, accountNoParamName,
            ...
            dateOfBirthParamName, genderParamName, mifosClientIdParamName));
