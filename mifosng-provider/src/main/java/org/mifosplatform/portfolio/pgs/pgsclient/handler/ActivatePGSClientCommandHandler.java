...
@Service
public class ActivatePGSClientCommandHandler implements NewCommandSourceHandler {

    private final PGSClientWritePlatformService clientWritePlatformService;

    @Autowired
    public ActivatePGSClientCommandHandler(final PGSClientWritePlatformService clientWritePlatformService) {
