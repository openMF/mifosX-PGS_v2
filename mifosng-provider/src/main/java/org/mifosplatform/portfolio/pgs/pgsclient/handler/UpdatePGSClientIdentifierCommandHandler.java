...
@Service
public class UpdatePGSClientIdentifierCommandHandler implements NewCommandSourceHandler {

    private final PGSClientIdentifierWritePlatformService clientIdentifierWritePlatformService;

    @Autowired
    public UpdatePGSClientIdentifierCommandHandler(final PGSClientIdentifierWritePlatformService clientIdentifierWritePlatformService) {
